        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/login">
                <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground" data-testid="hero-get-started">
                  <i className="fas fa-play mr-2"></i>
                  Start Creating Today
                </Button>
              </Link>
              <Button variant="secondary" size="lg" data-testid="hero-watch-demo">
      ...
      <section className="py-20 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h3 className="text-3xl md:text-4xl font-bold mb-4">Powerful Features for Every Family</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="glass-effect hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">AI Voice Cloning</h4>
                <p className="text-muted-foreground">Clone family voices with just a few audio samples and bring stories to life</p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">Real-time Collaboration</h4>
                <p className="text-muted-foreground">Work together as a family to create videos in real-time from anywhere</p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <h4 className="text-xl font-semibold mb-2">AI Script Generation</h4>
                <p className="text-muted-foreground">Generate engaging family stories and scripts using advanced AI technology</p>
              </CardContent>
            </Card>
            ...
            <Card className="glass-effect hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground">Choose from curated video templates designed specifically for family stories</p>
              </CardContent>
            </Card>
          </div>
        </div>
